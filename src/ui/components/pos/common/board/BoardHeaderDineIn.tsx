...
const BoardHeaderDineIn = () => {
  const [searchParams] = useSearchParams();
  return (
    <div className="p-3 flex gap-1 flex-col h-[72px]">
      <div className="flex items-center gap-2">
        ...
        <div className="flex gap-2">
          ...
          <Badge className="rounded-full bg-border text-black dark:text-black font-medium">
            20:33
          </Badge>
        </div>
      </div>
...
export default BoardHeaderDineIn;

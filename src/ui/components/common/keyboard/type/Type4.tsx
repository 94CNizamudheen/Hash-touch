    ...
    <div className="flex flex-col space-y-2 p-4 rounded-lg w-full h-full max-w-xl mx-auto">
      ...
      <div className="grid-cols-7 grid space-x-2">
        <button
          ...
          className="col-span-2 h-12 text-foreground rounded-lg bg-background shadow flex justify-center items-center text-lg font-medium"
        >
          .
        </button>
        <button
      ...
      <div className="grid-cols-7 grid space-x-2">
        <button
          ...
          className="col-span-7 h-12 text-foreground rounded-lg bg-background shadow flex justify-center items-center text-lg font-medium"
        >
          ABC
        </button>
      </div>
